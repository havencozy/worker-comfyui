...
group "default" {
  targets = ["base", "sdxl", "sd3", "flux1-schnell", "flux1-dev", "flux1-dev-fp8", "flux2-dev", "z-image-turbo", "base-cuda12-8-1"]
}
...
target "flux2-dev" {
  ...
  tags = ["${DOCKERHUB_REPO}/${DOCKERHUB_IMG}:${RELEASE_VERSION}-flux2-dev"]
  inherits = ["base"]
}
